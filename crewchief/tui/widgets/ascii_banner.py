  ...
  ╚██████╗╚██████╔╝███████╗╚███╔███╔╝╚██████╗██║  ██║██║███████╗███████╗
   ╚═════╝ ╚═════╝ ╚══════╝ ╚══╝╚══╝  ╚═════╝╚═╝  ╚═╝╚═╝╚══════╝╚══════╝
    ...
    def get_alt_banner_3() -> str:
        """Alternative banner design 3: Box with bigger CREWCHIEF ASCII."""
        return r"""
    ╔══════════════════════════════════════════════════════════════════╗
    ║                                                                  ║
    ║     _____ _____ ______ _  _ _____ _____ _  _ _____ _____      ║
    ║    / ____|  __ \|  ____| || |/ ____|  __ \|  \/  |  |  _ \    ║
    ║   | |    | |__) | |__  | || | |    | |__) | |\/| |  | |_) |   ║
    ║   | |    |  _  /|  __| |__| | |    |  _  /| |  | |  |  _ <    ║
    ║   | |____| | \ \| |____ __  | |____| | \ \| |  | |__| |_) |   ║
    ║    \_____|_|  \_\______|____|_____|_|  \_\_|  |_|___|____/    ║
    ║                                                                  ║
